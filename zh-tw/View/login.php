	...
	<div id="login">
		<div id="header" style="width:auto;text-align:center">
			...
			<div style="clear:both"></div>
				...
				<font style="font-size: 12px;margin-left:0px;float:none">專注LNMP / Nginx 虛擬主機面板 - AMH</font>
				</div>		
		</div>
		...
		?>			
			<p>
				<dl><dt id="UserDom">管理員賬號</dt><dd><input type="text" name="user" class="input_text" value="<?php echo isset($_POST['user']) ? $_POST['user'] : '';?>" / ></dd></dl>
				<dl><dt id="PassDom">管理員密碼</dt><dd><input type="password" name="password" class="input_text" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '';?>"/ ></dd></dl>
				
				<?php if ($amh_config['VerifyCode']['config_value'] == 'on') { ?>
				<dl><dt><a name="location_code"></a>驗證碼</dt>
				...
				<dl><dd id="login_submit"><button name="login" class="primary button" type="submit"  id="SubmitDom"> 登錄 </button>
				</dd></dl>
			</p>

			<p style="margin:20px 0px;text-align:left">Powered by <a href="http://amysql.com/" target="_blank">Amysql.com</a>|Translated By <a href="http://git.oschina.net/codebyme/Language-Project-AMH" target="_blank">Codebyme</a></p>
		</form>
