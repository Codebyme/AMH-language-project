...
var connect_check = function (obj)
{
	...
	{
		obj.innerHTML = '<span class="loop icon"></span><font color="red">請求超時</font>';
	...
	Ajax.get(obj.href + '&tag=' + Math.random(),function (msg){
		var status = ( msg.indexOf('OK') != -1 ) ? '<font color="green">鏈接成功</font>' : '<font color="red">鏈接失敗</font>';
